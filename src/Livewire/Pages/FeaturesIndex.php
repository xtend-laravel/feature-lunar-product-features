...
namespace XtendLunar\Features\ProductFeatures\Livewire\Pages;
...
class FeaturesIndex extends Component
{
     ...
     *
     * @return \XtendLunar\Features\ProductFeatures\Models\ProductFeature
     */
     ...
     *
     * @return \XtendLunar\Features\ProductFeatures\Models\ProductFeatureValue
     */
    ...
    {
        return view('adminhub::livewire.pages.product-feature-index')
